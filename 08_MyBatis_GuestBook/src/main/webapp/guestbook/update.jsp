...
<%
	// 전달받은 데이터 확인(session에 저장되어 있는 데이터)
...
<script>
	function save_go(frm) {
		...
		frm.action = "update_ok.jsp" // DB수정 작업 처리 페이지
		frm.submit();
	}
</script>
</head>
		...
		<form method="post">
			...
			<colgroup>
				...
				<tbody>
					...
					<tr>
						<td colspan="2"><textarea name="content" rows="5" cols="60">${guestbookVO.content }</textarea></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
