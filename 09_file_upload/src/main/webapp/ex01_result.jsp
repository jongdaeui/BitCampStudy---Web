...
<%
	...
	// request객체를 통한 파라미터 값 조회가 불가능하다 (MultipartRequest 사용)
	...
	MultipartRequest mr = new MultipartRequest(
			request, // 요청객체
			path, // 실제파일을 저장할 경로
			10 * 1024 * 1024, // 업로드 파일 최대 크기 지정(byte 단위)
			"UTF-8", // 인코딩 형식
...
%> 
	...
	<h2>파일(file) : <%=mr.getParameter("f_name") %></h2> <!-- 사용 불가 : null 값 리턴 -->
...
<%
	...
	out.print("<h2>" + file.getName() + "</h2>");
	out.print("<h2>" + file.length() + "</h2>");
%>
	<hr>
	<h2>파일 다운로드</h2>
